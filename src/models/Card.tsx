...
export const createCardStore = (attributes: Partial<Card>, onChange: () => void) => {
  const defaultCardAttributes: Card = {
    ...
    text: [
      ...
      '[subroutine] You may draw 1 card.',
      '[subroutine] Shuffle up to one card from HQ or Archives into R&D for every card you have drawn this turn.',
      '',
      '[cardname] costs 0 influence while included in an NBN deck.',
    ].join('\n'),
    fluff: '',
    img: '',
    imgUrl: defaultImage,
